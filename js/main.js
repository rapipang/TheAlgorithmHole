...
Stage.prototype.init = function () {
  ...
  this.jumpVal = 1;
  this.isNear = false;
  this.rampUpFX = new Audio('/asset/rampUp_Sfx.mp3');
...
Stage.prototype.onScroll = function () {
    ...
    this.EaseVal = lerp(0, this.scrSpeed * 15, 0.0001, 0, 0.0000001);
...
function Particle(scene) {
  ...
  this.offset = new THREE.Vector3((Math.random() - 0.5) * 2.5 * (Math.random() + 0.5), (Math.random() - 0.5) * 3 * Math.random(), (Math.random() - 0.5) * 2);
